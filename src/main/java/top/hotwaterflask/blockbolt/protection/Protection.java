...
public interface Protection {
     ...
     */
    /**
     * Gets whether the door at the specific clicked block is currently opened.
     * Defaults to {@link #isOpen()}.
     *
     * @param clickedBlock The block that was clicked.
     * @return True if open, false otherwise.
     */
    default boolean isOpen(Block clickedBlock) {
        return isOpen();
    }

    /**
     * Opens or closes the specific clicked block (and its paired double door if applicable).
     * Defaults to {@link #setOpen(boolean, SoundCondition)}.
     *
     * @param clickedBlock The clicked block.
     * @param open True to open, false to close.
     * @param playSound Sound condition.
     */
    default void setOpen(Block clickedBlock, boolean open, SoundCondition playSound) {
        setOpen(open, playSound);
    }
